 ...
 * @package captcha
 * @version 0.3
 * @modify pony_chiang <jxcent@gmail.com>
 *
 */
...
array (214, 36, 7 ) );// red
	...
	function GetDictionaryCaptchaText($extended = false) {
		...
		// changes words method for array
		$array_words = require $wordsfile;
		$length = count ( $array_words ) - 1;
		if (! $length) {
			return false;
		}
		
		$text = trim ( $array_words [mt_rand ( 0, $length )] );
